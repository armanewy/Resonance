...
The probe is not a production integration. Unrelated-listing visibility is an empirical result, not a permission assumption. The probe exists to decide whether the official API surface can support a later read-only OfferLab pilot.
